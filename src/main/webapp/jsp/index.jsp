    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="row">
                <div class="col-lg-3 col-xs-6">
                    ...
                    <div class="small-box bg-aqua">
                        ...
                        <div class="icon" style="position: absolute;top:7px">
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-8">
                                    <p class="text-center">
                                        <strong>销售：2018年1月1日 - 2018年7月30日</strong>
                                    </p>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <!-- /.progress-group -->
                                    <div class="progress-group">
                                        <span class="progress-text">访问高级页</span>
            ...
            <div class="row">
                                ...
                                <div class="col-md-3 col-sm-4">
                                    <div class="pad box-pane-right bg-green" style="min-height: 280px">
                                        ...
                                        <div class="description-block margin-bottom">
                                            ...
                                            <span class="description-text">入住商家</span>
                                        </div>
                                        <!-- /.description-block -->
                                        <div class="description-block">
                                            <div class="sparkbar pad" data-color="#fff">90,50,90,70,61,83,63</div>
                                            <h5 class="description-header">70%</h5>
                                            <span class="description-text">成交</span>
                                        </div>
                                        <!-- /.description-block -->
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="box box-primary">
                                ...
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <ul class="products-list product-list-in-box" style="margin: 12px 0 14px 0;">
                                        <li class="item">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="box box-danger">
                                <div class="box-header with-border">
                                    <h3 class="box-title">最新商家</h3>

                                    <div class="box-tools pull-right">
                                        <span class="label label-danger">8 家店铺</span>
                                        <button type="button" class="btn btn-box-tool" data-widget="collapse"><i
                                                class="fa fa-minus"></i>
                                        </button>
                                    </div>
                ...
                <div class="col-md-4">
                    <!-- Info Boxes Style 2 -->
                    <div class="info-box bg-yellow" style="margin-bottom: 11px;">
                        <span class="info-box-icon"><i class="ion ion-ios-pricetag-outline" style="
    position: absolute;
    top: 22px;
    left: 42px;
"></i></span>
                    ...
                    <!-- /.info-box -->
                    <div class="info-box bg-green" style="margin-bottom: 11px;">
                        <span class="info-box-icon"><i class="ion ion-ios-heart-outline" style="
    position: absolute;
    top: 124px;
    left: 42px;
"></i></span>
                    ...
                    <!-- /.info-box -->
                    <div class="info-box bg-red" style="margin-bottom: 11px;">
                        <span class="info-box-icon"><i class="ion ion-ios-cloud-download-outline" style="
    position: absolute;
    top: 230px;
    left: 42px;
"></i></span>
                    ...
                    <div class="info-box bg-aqua" style="margin-bottom: 10px;">
                        <span class="info-box-icon"><i class="ion-ios-chatbubble-outline" style="
    position: absolute;
    top: 329px;
    left: 44px;
"></i></span>
                ...
                <div class="col-md-12">
                    <div class="box box-info">
                            ...
                            <div class="table-responsive">
                                <table class="table no-margin">
                                    ...
                                    <tr>
                                        ...
                                        <td>三星智能电视</td>
                                        <td><span class="label label-warning">运</span></td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>iPhone 6 Plus</td>
                                        <td><span class="label label-danger">交付</span></td>
                                        <td>
                        ...
                        <div class="box-footer clearfix">
                            <a href="javascript:void(0)" class="btn btn-sm btn-info btn-flat pull-left">下新订单</a>
